...
const page = () => {
  return (
    <div className='w-full h-full flex flex-col items-center justify-center relative gap-5 overflow-scroll bg-[#1d4325]'>
        <NavBar />
  ...
  <br></br><br></br>
  <span className='text-4xl'>The Haggle Stage:</span><br></br>
  ...
  <br></br>
  <span className='text-4xl'>The Bidding Stage:</span><br></br>
  ...
  <br></br>
  <span className='text-4xl'>Card Rules:</span><br></br>
