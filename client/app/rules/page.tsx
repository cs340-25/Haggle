  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center relative gap-5 overflow-scroll bg-[#1d4325] font-impact font-black '>
        ...
        <div className="bg-[#1b4381] w-[75vw] rounded-[20px] border-[#5c6ead] border-2">
          <div className='text-center text-[3vh] p-[5vh] text-[#ffdebd] font-light '>
          <span className='text-[8vh]'>How to Play </span>
          <br></br><br></br>
          <span className='text-[5vh]'>The Auction Stage:</span>
          <br></br>
          At the start of each round the deck is shuffled and each player draws 5 cards and begin the Haggle stage. 
          <br></br><br></br>
          <span className='text-[5vh]'>The Haggle Stage:</span><br></br>
          ...
          <br></br>
          <span className='text-[5vh]'>The Bidding Stage:</span><br></br>
          ...
          <br></br>
          <span className='text-[5vh]'>Card Rules:</span><br></br>
