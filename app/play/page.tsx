...
import GameWrapper from '../components/game_comps/GameWrapper';

const page = () => {
  return (
    <div className='w-full h-full flex flex-col items-center justify-center relative gap-5 min-h-screen overflow-hidden bg-[#1d4325] font-impact font-black '>
        <NavBar />
